...
function crearCard(tituloProducto, imagenProducto, nombreProducto, precioProducto, idProducto){
    const producto = document.createElement("li");
    producto.className= "producto"
    producto.innerHTML=`<div class="contenedor-titulo">
    ...
    botonEliminar.addEventListener("click", async () => {
        try {
            await conexionAPI.eliminarProducto(idProducto); // Función que llama al DELETE en conexionAPI
        } catch (error) {
